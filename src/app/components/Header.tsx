...
import logobgg from "../../../public/logo-text.webp"
...
const Header = () => {
    ...
    />
                ...
                <div className="flex  items-center space-x-4">
                    ...
                    <Button className="hover:scale-105  hover:text-black bg-amber-700 rounded-md transition-transform shadow-lg">Đăng ký ngay</Button>
                </div>
            </div>
        </header>
    );
